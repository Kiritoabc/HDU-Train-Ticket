...
<!--                                <el-input v-model="registerForm.user_type" placeholder="用户类型(成人/学生)"><span>dsfsf</span></el-input>-->
                                <el-select v-model="registerForm.passenger_type" placeholder="乘客类型">
...
<!--                                <el-input v-model="registerForm.user_gender" placeholder="性别"><span>dsfsf</span></el-input>-->
                                <el-select v-model="registerForm.user_gender" placeholder="性别">
        ...
        methods: {
            async submitForm(formName) {
                this.$refs[formName].validate(async (valid) => {
                    if (valid) {
                        const res = await register({userPhoneNumber: this.registerForm.user_phone_number,
                            userPassword: this.registerForm.user_password, userPassword2:this.registerForm.user_password_2,
                            userRealName:this.registerForm.user_real_name,userEmail:this.registerForm.user_email,userIdNumber:this.registerForm.user_id_number
                        ,userType:this.registerForm.user_type,userGender:this.registerForm.user_gender ,userAddress:this.registerForm.user_address })
                        console.log("============res============"+res);
                        if (res.status === 1) {
                            this.$message({
                                type: 'success',
